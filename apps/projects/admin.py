...
class SampleAdmin(admin.ModelAdmin):
    list_display = ('name', 'project', 'sample_type', 'created_at')
...
class StepRunAdmin(admin.ModelAdmin):
    list_display = ('id', 'sample', 'step', 'status', 'created_at', 'started_at', 'finished_at', 'is_pinned')
    list_filter = ('status', 'is_pinned')
    search_fields = ('id', 'sample__name', 'step__name')
